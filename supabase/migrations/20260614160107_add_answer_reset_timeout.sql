-- Add last_answer_reset_at to profiles
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS last_answer_reset_at TIMESTAMP WITH TIME ZONE;

-- Create secure function to reset today's answers with a 7-day timeout
